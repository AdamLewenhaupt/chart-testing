var DRAGGING, GRAPH_MARGINS, INACTIVE, LINECOLORS, RESULT_MARGINS, colorOffset, colorStep, createDrag, createHeader, createLine, createPoints, generateAxises, generateBackground, generateChart, generateGraphAxises, generateResult, i, j, onMouseLeaveLineOrDot, onMouseoverLineOrDot, randomResult, timeParser, timeParserMany;
...
$(function() {
  ...
  return $.getJSON('/data.json', function(data) {
    var height, information, k, len, line, lineGen, lines, pointDrag, points, range, vis, width, xScale, yScale;
